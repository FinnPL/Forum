...
public class CommentController {
    ...
    @Autowired public CommentController(CommentService commentService, UserService userService) {
    ...
    public void addComment(@RequestBody CommentRequest commentRequest) {
        ...
        comment.setUser(userService.findUserById(UUID.fromString(commentRequest.getUser_id())).orElseThrow());
