...
public class AuthenticationControllerTest {
    ...
    public void testRegisterAndAuth() {
        ...
        ResponseEntity<AuthenticationResponse> response = restTemplate.postForEntity("/api/v1/auth/register", loginRequest, AuthenticationResponse.class);
        ...
        response = restTemplate.postForEntity("/api/v1/auth/authenticate", loginRequest, AuthenticationResponse.class);
